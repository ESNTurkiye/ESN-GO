...
export const GUIDE_CATEGORIES: GuideCategory[] = [
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                content: 'Finding the right accommodation is one of the most important steps of your Erasmus journey. Whether you prefer a university dormitory, a shared apartment, or a private studio, Türkiye offers plenty of options for international students at various price ranges.'
            },
            {
                type: 'tip',
                content: 'Start your housing search at least 2 months before your arrival. The best options go fast, especially in popular cities like Istanbul and Ankara!'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'Sharing an apartment with other students is the most popular option among Erasmus students. You\'ll get more independence and a chance to experience local life. Monthly rent for a shared room ranges from ₺3,000–₺8,000 depending on the city and neighborhood.'
            },
            {
                type: 'tip',
                content: 'Never send money before visiting the apartment in person! Scams targeting international students are common. Always verify the landlord and the property.'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'paragraph',
                content: 'When you find a place, always sign a proper rental contract (kira sözleşmesi). This protects both you and the landlord. Make sure the contract is in both Turkish and English if possible.'
            },
            {
                type: 'list',
                content: [
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                content: 'Getting a Turkish SIM card is essential for staying connected during your exchange. You\'ll need it for mobile internet, making local calls, and registering for many Turkish services that require a Turkish phone number.'
            },
            {
                type: 'tip',
                content: 'Buy your first SIM card at the airport — there are Turkcell and Vodafone counters at arrivals. Tourist SIM packages are the easiest way to get started!'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'Türkiye has three major mobile operators. Each offers special tourist and student packages:'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'paragraph',
                content: 'If you plan to stay in Türkiye for more than 120 days, you MUST register your phone\'s IMEI number. Unregistered foreign phones will be blocked from Turkish networks after the 120-day period.'
            },
            {
                type: 'tip',
                content: 'Register your IMEI at a tax office (Vergi Dairesi) or through the e-Devlet online portal. The fee is approximately ₺20,000 (2025), so consider buying a local phone instead if yours is expensive.'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'paragraph',
                content: 'All three operators offer student-specific plans with extra data and discounted rates. Bring your student ID and passport to any operator store to sign up.'
            },
            {
                type: 'list',
                content: [
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                content: 'Understanding the Turkish banking system and managing your finances smartly will save you both money and headaches. Here\'s everything you need to know about banking, currency exchange, and money management as an exchange student.'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'Having a Turkish bank account makes your life much easier — from paying rent to receiving any local scholarships. Most banks are foreigner-friendly, but some are easier than others.'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'tip',
                content: 'Get your Turkish Tax Number (Vergi Numarası) first! You can\'t open a bank account without it. Visit any Tax Office (Vergi Dairesi) with your passport — it takes about 15 minutes and it\'s free.'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'If you don\'t want to open a local bank account right away, international fintech apps work well in Türkiye for everyday spending and ATM withdrawals.'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'tip',
                content: 'Always pay in Turkish Lira (₺) when using your foreign card. If a terminal asks "pay in EUR/USD or TRY?", always choose TRY to avoid poor exchange rates (Dynamic Currency Conversion).'
            }
        ],
        offers: [
            {
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                content: 'Your Erasmus semester is the perfect time to explore Türkiye beyond your university city. With affordable domestic flights, comfortable buses, and well-connected trains, weekend trips are easy and budget-friendly.'
            },
            {
                type: 'tip',
                content: 'ESN organizes group trips almost every weekend! Check your local section\'s social media for upcoming trips — they\'re usually much cheaper than booking solo.'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'Getting around Türkiye is quite affordable compared to Western Europe. Here are your main options:'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'tip',
                content: 'Book bus tickets on obilet.com — you can compare prices across all companies and book in English. For flights, check Pegasus Airlines for the cheapest fares.'
            },
            {
                type: 'heading',
                content: 'Budget Tips'
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                content: 'From booking accommodation to reserving restaurant tables and buying event tickets, here\'s a guide to essential booking platforms and tips for exchange students in Türkiye.'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'Turkish events sell out fast, especially concerts and football matches. Book in advance to avoid disappointment.'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'tip',
                content: 'Want to watch a football match? You\'ll need a Passolig card (electronic fan card). Apply online at passo.com.tr — it takes about 1 week to receive. Most stadiums don\'t sell tickets without it!'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'Popular restaurants in big cities can be fully booked, especially on weekends. Here\'s how to secure your table:'
            },
            {
                type: 'list',
                content: [
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                content: 'Choosing the right neighborhood can make or break your Erasmus experience. Each Turkish city has distinct neighborhoods with different vibes, price ranges, and accessibility. Here\'s what you need to know.'
            },
            {
                type: 'heading',
            ...
            {
                type: 'tip',
                content: 'Ask your ESN buddy which neighborhoods are closest to your campus and fit your budget. They know the local scene best!'
            },
            {
                type: 'heading',
                content: 'Safety Tips'
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                content: 'The ESNcard is the most important card you\'ll carry during your exchange. It gives you access to discounts, events, and a community of 500,000+ students across 42 countries.'
            },
            {
                type: 'tip',
                content: 'Get your ESNcard during Welcome Week from your local ESN section! It costs €10 and is valid for 1 year. It will save you hundreds of euros in discounts.'
            },
            {
                type: 'heading',
            ...
            {
                type: 'paragraph',
                content: 'Many local businesses in Türkiye partner with ESN to offer exclusive discounts to ESNcard holders. Check the ESNcard app for nearby deals.'
            },
            {
                type: 'list',
                content: [
            ...
            {
                type: 'paragraph',
                content: 'Your ESNcard also gives you priority access and discounted tickets to all ESN events — from local parties to international trips and the famous Erasmus Gala.'
            }
        ],
        offers: [
            {
