            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <form className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center justify-center">
                    ...
                    <Button
                        size="lg"
                        type="submit"
                        className="bg-[#EC008C] hover:bg-[#EC008C]/90 text-white font-bold rounded-full px-6 sm:px-8 py-3 sm:py-4 whitespace-nowrap shadow-[0px_4px_15px_rgba(236,0,140,0.3)] touch-target"
