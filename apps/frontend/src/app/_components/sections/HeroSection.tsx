...
export default function HeroSection() {
    ...
    return (
        <section
            id="hero"
            className="relative -mt-16 md:-mt-24 min-h-dvh w-full overflow-hidden"
        >
            ...
            <div className="relative z-20 flex flex-col items-center justify-center min-h-dvh pt-16 md:pt-24 container-responsive text-center">
