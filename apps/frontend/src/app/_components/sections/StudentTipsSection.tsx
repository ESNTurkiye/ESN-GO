        ...
        >
            ...
            >
                ...
                <div className="min-w-0">
                    <p className="font-oswald font-bold text-esn-dark-blue text-sm truncate">
                        {item.author}
                    </p>
                    <p className="text-gray-600 font-lato text-xs truncate">
                        {item.university}
                    </p>
                </div>
            </div>
            ...
            <div className="w-full">
                <div className="text-center mb-12 sm:mb-16 px-4">
                    ...
                    <p className="text-lg text-gray-600 font-lato max-w-3xl mx-auto">
                        Real tips from Erasmus students who&apos;ve been there,
                        done that
                    </p>
                </div>
