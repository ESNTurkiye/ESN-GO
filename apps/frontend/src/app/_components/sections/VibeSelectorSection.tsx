            ...
            <div className="max-w-7xl mx-auto container-responsive">
                <div className="text-center mb-12">
                    ...
                    <p className="fluid-body-md text-gray-600 font-lato max-w-3xl mx-auto">
                        What&apos;s your mood? Filter experiences by how you
                        feel
                    </p>
                </div>
                    ...
                    {destinations
                        ...
                        .map((dest) => (
                            ...
                            >
                                ...
                                />
                                <div
                                    className={`absolute inset-0 bg-linear-to-t ${dest.overlayColor} via-black/40 to-transparent`}
                                ></div>
                        ...
                        {destinations
                            ...
                            .map((dest) => (
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        className={`absolute inset-0 bg-linear-to-t ${dest.overlayColor} via-black/30 to-transparent`}
                                    ></div>
                                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 z-10">
                                        {dest.badge && (
                                            <span
                                                className={`inline-block px-2.5 sm:px-3 py-1 ${dest.badgeColor} text-white text-xs font-oswald font-bold rounded-full mb-1.5 sm:mb-2`}
                                            >
                                                {dest.badge}
                                            </span>
                                        )}
                                        <h3 className="text-xl sm:text-2xl font-oswald font-bold text-white mb-1 sm:mb-2">
                                            {dest.title}
                                        </h3>
