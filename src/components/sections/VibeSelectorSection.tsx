    ...
    <section className="section-padding bg-white">
      <div className="max-w-7xl mx-auto container-responsive">
        <div className="text-center mb-12">
          <h2 className="fluid-heading-lg font-oswald font-bold text-esn-dark-blue mb-4 uppercase">
            Start with a Vibe
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
            {vibes.map((vibe) => (
              <button
                ...
                className={`touch-target px-6 sm:px-8 py-3 rounded-full font-oswald font-bold uppercase text-sm transition-all duration-300 ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
          <div className="lg:col-span-7 relative h-[400px] sm:h-[500px] rounded-2xl overflow-hidden shadow-xl group cursor-pointer">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10">
              ...
              <h3 className="text-3xl sm:text-4xl md:text-5xl font-oswald font-bold text-white mb-3 sm:mb-4 uppercase leading-tight">
              ...
              <button 
                className="touch-target px-5 sm:px-6 py-2.5 sm:py-3 bg-white text-esn-magenta rounded-lg font-oswald font-bold uppercase hover:-translate-y-0.5 transition-all flex items-center gap-2"
          ...
          <div className="lg:col-span-5 space-y-4 sm:space-y-6">
            <div className="relative h-48 sm:h-60 rounded-2xl overflow-hidden shadow-lg group cursor-pointer">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                <h3 className="text-xl sm:text-2xl font-oswald font-bold text-white mb-1 sm:mb-2 uppercase">Black Sea Nature</h3>
            ...
            <div className="relative h-48 sm:h-60 rounded-2xl overflow-hidden shadow-lg group cursor-pointer">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                <span className="inline-block px-2.5 sm:px-3 py-1 bg-esn-cyan text-white text-xs font-oswald font-bold uppercase rounded-full mb-1.5 sm:mb-2">
                  ESNcard -30%
                </span>
                <h3 className="text-xl sm:text-2xl font-oswald font-bold text-white mb-1 sm:mb-2 uppercase">Pamukkale Thermal</h3>
